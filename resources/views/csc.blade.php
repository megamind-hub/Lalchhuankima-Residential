...
<body onload="loadAgeSelector()">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown" style="text-align:right;">
	...
	<form class = "form-inline" action="forms" enctype="multipart/form-data" method="POST">
		@csrf
		<fieldset>
		...
		<div class="profile">
			...
			<input type="text" id="name" class="namess" name="name" placeholder="Your name" size ="35" maxlength="30" required>
			...
			<label for="PoB">Place of Birth:* </label>
				...
				<input list="occupation" name="occupation" type="text" placeholder="Occupation" required>
		...
		<div class="address">
				...
				<select name="state" id="state" class="form-control" name="pas">
				...
				<input list="police" type="text" placeholder="police" name="police" required>
				<datalist id="police">
				...
				<label>Details of residence for last 20 years(including direct ancestor):* </label>
					<input type="textarea" name="residence" maxlength="255" style="height: 50px; width: 588px" required>
			</div>		
		</fieldset>
		<fieldset>
		...
		<div class="addinfo">
				<label>Place of enrollment on E/Roll Constituency No:* </label>
					<input type="text" name="enrollment" maxlength="4" size="25" placeholder="Either applicant/parent" required>

				<label>Constituency Name:* </label>
					<input type="text" name="constituency" maxlength="60" size="30" required>

				<label>Electoral Roll ID Card No.:* </label>
				<input type="text" name="idcard" size="25" required>
				...
				<input type="textarea" name="purpose" maxlength="255" style="height: 50px; width: 588px" required>
		</div>
		</fieldset>
		...
		<input type="file" id="myFile" name="file1" style="margin-left:70px;"> <br>
		<label>Village Council Paper: </label>
		<input type="file" id="myFile" name="file2" style="margin-left:16px;"> <br>
		<label>Others: </label>
		<input type="file" id="myFile" name="file3" style="margin-left:115px;"> <br>
		</fieldset>
		...
		<span>
			...
			<input type="checkbox" name="decleration" id="decleration" class="decleration" style="margin-right: 15px;">
    ...
    <footer class="foot">
		<div>
			...
			<img src="/css/NeGS.jpg" class="image" width="70px" ALIGN='right'>
			</p>
		</div>
		<div class="texts">
