...
<link href="{{ asset('css/app.css') }}" rel="stylesheet">
	...
	<link href="design/cscHome.css" rel="stylesheet" type="text/css">
    <title>CSC HOME PAGE</title>
  </head>
  <body>
  @if(session('message'))
        <div style="text-align:center;" class="alert alert-success">{{session('message')}}</div>
    @endif
  <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
              <p class="homepage">  <a class="navbar-brand" href="{{ url('/') }}">
                    HOME
               		 </a>
			  </p>
	 ...
	 <span>
    <h1 class="p-3 mb-2 bg-success text-white">CSC HOME PAGE</h1>
